        ...
        <Box>
          <Stack>
            <Box>
              ...
              <Typography sx={{fontSize: { xs: "1rem", md: "1.3rem", height: {xs: "2rem", md: "20rem"} }}}>“The ease of delivery is one that I depended on when I was bedriden and couldn’t even walk. Their services is awesome”</Typography>
            </Box>
